...
for epoch in range(epochs):
    ...
    print(f"Epoch [{epoch+1}/{epochs}], d_loss: {d_loss_total/batch_count:.4f}, g_loss: {g_loss_total/batch_count:.4f}")
...
# Display results
# Save results
def display_denoised_images(noisy, denoised, original, num=5, save_path="denoised_results.png"):
